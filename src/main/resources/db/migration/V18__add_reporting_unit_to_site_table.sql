...
DROP TABLE IF EXISTS public.site_assessment_criteria;

DROP TABLE IF EXISTS public.assessment_result_log;


ALTER TABLE public.site DROP COLUMN IF EXISTS description;
ALTER TABLE IF EXISTS public.site ADD COLUMN name VARCHAR(255) UNIQUE NOT NULL;
ALTER TABLE public.site DROP COLUMN IF EXISTS active;
ALTER TABLE IF EXISTS public.site ADD COLUMN is_active BOOLEAN;
ALTER TABLE IF EXISTS public.site ADD COLUMN mdm_site_id BIGINT UNIQUE NULL;
ALTER TABLE IF EXISTS public.site ADD COLUMN mdm_site_name VARCHAR(255);
ALTER TABLE IF EXISTS public.site ADD COLUMN region VARCHAR(255);
ALTER TABLE IF EXISTS public.site ADD COLUMN enterprise VARCHAR(255);
ALTER TABLE IF EXISTS public.site ADD COLUMN business_group VARCHAR(255);
ALTER TABLE IF EXISTS public.site DROP COLUMN IF EXISTS business_unit;
ALTER TABLE IF EXISTS public.site ADD COLUMN reporting_unit VARCHAR(255);
ALTER TABLE IF EXISTS public.site ADD COLUMN address VARCHAR(50);
ALTER TABLE IF EXISTS public.site DROP COLUMN IF EXISTS country;
ALTER TABLE IF EXISTS public.site ADD COLUMN country VARCHAR(50);
ALTER TABLE IF EXISTS public.site ADD COLUMN country_code VARCHAR(5);
ALTER TABLE IF EXISTS public.site ADD COLUMN city VARCHAR(50);
ALTER TABLE IF EXISTS public.site ADD COLUMN state VARCHAR(50);