...
ALTER TABLE public.assessment_result_log ALTER COLUMN old_recommendation_description TYPE VARCHAR(1000);

ALTER TABLE public.assessment_result_log ALTER COLUMN new_recommendation_description TYPE VARCHAR(1000);

ALTER TABLE public.assessment_result_log ALTER COLUMN old_notes TYPE VARCHAR(1000);

ALTER TABLE public.assessment_result_log ALTER COLUMN new_notes TYPE VARCHAR(1000);


ALTER TABLE public.site
DROP CONSTRAINT fk_site_country_id;

ALTER TABLE public.site
DROP CONSTRAINT fk_business_unit_id;

ALTER TABLE public.site
DROP CONSTRAINT fk_investment_criticality_id;
